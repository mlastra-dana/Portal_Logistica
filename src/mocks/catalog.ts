...
// Rangos de referencia típicos en adultos. Ajustable por laboratorio.
export const examCatalog: ExamCatalogItem[] = [
  ...
  { id: "ua", displayName: "Ácido úrico", category: "Bioquimica", unit: "mg/dL", resultType: "numeric", referenceRange: { min: 3.4, max: 7.0 } },
  ...
  { id: "tg", displayName: "Triglicéridos", category: "Bioquimica", unit: "mg/dL", resultType: "numeric", referenceRange: { max: 150, text: "Deseable <150" } },
  ...
  { id: "ur-protein", displayName: "Orina - Proteínas", category: "Orina", resultType: "qualitative", referenceRange: { text: "NEG" } },
  { id: "ur-glu", displayName: "Orina - Glucosa", category: "Orina", resultType: "qualitative", referenceRange: { text: "NEG" } },

  { id: "crp", displayName: "Proteína C Reactiva (PCR/CRP)", category: "Serologia", unit: "mg/L", resultType: "numeric", referenceRange: { max: 5 } },
];
...
export const examPanels: ExamPanel[] = [
  ...
  { id: "perfil-lipidico", displayName: "Perfil lipídico", category: "Bioquimica", parameterIds: ["chol", "hdl", "ldl", "tg"] },
  { id: "metabolico", displayName: "Panel metabólico básico", category: "Bioquimica", parameterIds: ["glu", "bun", "crea", "ua"] },
  ...
  { id: "inflamacion", displayName: "PCR (inflamación)", category: "Serologia", parameterIds: ["crp"] },
];
